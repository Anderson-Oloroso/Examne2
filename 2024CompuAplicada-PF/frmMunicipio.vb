...
Imports iTextSharp.text
    ...
    Public Class frmMunicipio
        ...
        Else
            ...
            Try
            sql = "DELETE FROM MUNICIPIO WHERE nombre = '" & txtNOMBRE.Text.Replace("'", "''") & "' AND cod_muni = '" & txtCOD.Text.Replace("'", "''") & "'"
    ...
    Private Sub btnImpri_Click(sender As Object, e As EventArgs) Handles btnImpri.Click
        Try
            ...
            Dim nombreArchivo As String = Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory) + "\MUNICIPIOS.pdf"
    ...
    Private Sub municipio()
        ...
        ejecutar.CommandText = sql
            Try
                ...
                While buscar.Read()
                dgvTotal.Rows.Add(buscar!cod_muni, buscar!nombre)
            End While
            Catch ex As Exception
