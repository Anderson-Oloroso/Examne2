...
Public Class frmCiudadanos
    ...
    Private Sub eliminar()
        ...
        Try
            sql = "DELETE FROM CIUDADANO WHERE region = '" & txtNOMBRE.Text.Replace("'", "''") & "' AND lugar_nacimiento = '" & txtApellido.Text.Replace("'", "''") & "'"
    ...
    Private Sub agregar()
        ...
        Try
            sql = "INSERT INTO CIUDADANO VALUES('" & nomb & "','" & munic & "')"
    ...
    Private Sub ciudadanos()
        ...
        Try
            ...
            While buscar.Read()
                dgvTotal.Rows.Add(buscar!nombre, buscar!apellido, buscar!lugar_nacimiento)
